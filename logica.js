      ...
      data.forEach((product) => {
          ...
          <div class="card-body">
            ...
            <p class="card-text">
              <br> Precio: ${product.price} $ <br/>
              <br>Sale!: ${product.discount}% OFF <br/>
              ${(product.description == 0)  ? "No hay descripcion"  : `<br>Sale!: ${product.description} % OFF <br/>`}
            </p>
            <a href="#" class="btn btn-primary">Comprar</a>
          </div>
        </div>
      ...
      data.forEach((product) => {
          ...
          <div class="card-body color-card">
            ...
            <p class="sizen-1">Desde</p>
              <br> Precio: ${product.price} $ <br/>
              ${(product.discount == 0)  ? ""  : `<span class="badge badge-danger">Danger</span><br>Sale!: ${product.discount} % OFF <br/>`}
            </p>
            <a href="#" class="btn btn-primary">Comprar</a>
          </div>
        </div>
